...
public class Gyrometer_GyrometerListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Gyrometer+GyrometerListener, Uno", Gyrometer_GyrometerListener.class, __md_methods);
	}

	public Gyrometer_GyrometerListener ()
	{
		super ();
		if (getClass () == Gyrometer_GyrometerListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Gyrometer+GyrometerListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
