...
public class Accelerometer_ShakeListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Accelerometer+ShakeListener, Uno", Accelerometer_ShakeListener.class, __md_methods);
	}

	public Accelerometer_ShakeListener ()
	{
		super ();
		if (getClass () == Accelerometer_ShakeListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Accelerometer+ShakeListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
