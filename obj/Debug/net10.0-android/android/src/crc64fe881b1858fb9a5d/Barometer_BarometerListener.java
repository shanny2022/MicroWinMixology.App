...
public class Barometer_BarometerListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Barometer+BarometerListener, Uno", Barometer_BarometerListener.class, __md_methods);
	}

	public Barometer_BarometerListener ()
	{
		super ();
		if (getClass () == Barometer_BarometerListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Barometer+BarometerListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
