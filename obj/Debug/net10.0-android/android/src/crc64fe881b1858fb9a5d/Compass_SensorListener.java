...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Compass+SensorListener, Uno", Compass_SensorListener.class, __md_methods);
	}
	...
	public Compass_SensorListener ()
	{
		...
		if (getClass () == Compass_SensorListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Compass+SensorListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
