...
public class Pedometer_StepCounterListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Pedometer+StepCounterListener, Uno", Pedometer_StepCounterListener.class, __md_methods);
	}

	public Pedometer_StepCounterListener ()
	{
		super ();
		if (getClass () == Pedometer_StepCounterListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Pedometer+StepCounterListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
