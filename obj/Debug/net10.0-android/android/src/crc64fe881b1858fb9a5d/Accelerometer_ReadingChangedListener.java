...
public class Accelerometer_ReadingChangedListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.Accelerometer+ReadingChangedListener, Uno", Accelerometer_ReadingChangedListener.class, __md_methods);
	}

	public Accelerometer_ReadingChangedListener ()
	{
		super ();
		if (getClass () == Accelerometer_ReadingChangedListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.Accelerometer+ReadingChangedListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
