...
public class ProximitySensor_ProximitySensorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.ProximitySensor+ProximitySensorListener, Uno", ProximitySensor_ProximitySensorListener.class, __md_methods);
	}

	public ProximitySensor_ProximitySensorListener ()
	{
		super ();
		if (getClass () == ProximitySensor_ProximitySensorListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.ProximitySensor+ProximitySensorListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
