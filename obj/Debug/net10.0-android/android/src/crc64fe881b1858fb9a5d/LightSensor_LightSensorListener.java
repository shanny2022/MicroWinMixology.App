...
public class LightSensor_LightSensorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.LightSensor+LightSensorListener, Uno", LightSensor_LightSensorListener.class, __md_methods);
	}

	public LightSensor_LightSensorListener ()
	{
		super ();
		if (getClass () == LightSensor_LightSensorListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.LightSensor+LightSensorListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
