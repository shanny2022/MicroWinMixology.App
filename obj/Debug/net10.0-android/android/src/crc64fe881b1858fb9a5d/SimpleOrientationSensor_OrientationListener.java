...
public class SimpleOrientationSensor_OrientationListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.SimpleOrientationSensor+OrientationListener, Uno", SimpleOrientationSensor_OrientationListener.class, __md_methods);
	}

	public SimpleOrientationSensor_OrientationListener ()
	{
		super ();
		if (getClass () == SimpleOrientationSensor_OrientationListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.SimpleOrientationSensor+OrientationListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
