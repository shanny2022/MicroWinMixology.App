...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Uno.UI.OnSystemUiVisibilityChangeListener, Uno.UI.Runtime.Skia.Android", OnSystemUiVisibilityChangeListener.class, __md_methods);
	}
	...
	public OnSystemUiVisibilityChangeListener ()
	{
		...
		if (getClass () == OnSystemUiVisibilityChangeListener.class) {
			mono.android.TypeManager.Activate ("Uno.UI.OnSystemUiVisibilityChangeListener, Uno.UI.Runtime.Skia.Android", "", this, new java.lang.Object[] {  });
		}
	}
