package crc645ac28bd133c75e56;


public class Geolocator_LocationListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Geolocation.Geolocator+LocationListener, Uno", Geolocator_LocationListener.class, __md_methods);
	}

	public Geolocator_LocationListener ()
	{
		super ();
		if (getClass () == Geolocator_LocationListener.class) {
			mono.android.TypeManager.Activate ("Windows.Devices.Geolocation.Geolocator+LocationListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
