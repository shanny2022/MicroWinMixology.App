package crc64958fff25419ca2ce;


public class StatusBar_InsetsListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.UI.ViewManagement.StatusBar+InsetsListener, Uno", StatusBar_InsetsListener.class, __md_methods);
	}

	public StatusBar_InsetsListener ()
	{
		super ();
		if (getClass () == StatusBar_InsetsListener.class) {
			mono.android.TypeManager.Activate ("Windows.UI.ViewManagement.StatusBar+InsetsListener, Uno", "", this, new java.lang.Object[] {  });
		}
	}
